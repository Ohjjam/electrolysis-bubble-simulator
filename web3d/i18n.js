...
(function (g) {
  ...
  const catalog = Object.assign({}, g.SIM_I18N_EN || {}, {
    ...
    "3D에서는 유로를 막지 않는 청록색 무두께 접촉면으로 표시합니다.": "In 3D it is shown as a teal, zero-thickness contact surface that does not obstruct the channel.",
    "PP mesh · Mesh 2 접촉면 (유로 무영향)": "PP mesh · Mesh 2 contact surface (no flow effect)",
    "PP mesh · Mesh 1 실제 두께": "PP mesh · Mesh 1 physical thickness",
    ...
    "음극측 ← 유로 · 음극 전극/PTL · 막 · 양극 전극/NF · PP mesh · 유로 → 양극측": "Cathode side ← channel · cathode electrode/PTL · membrane · anode electrode/NF · PP mesh · channel → anode side",
    "음극측 셀 외판": "Cathode-side outer plate",
    "양극측 셀 외판": "Anode-side outer plate",
    "음극 전극/PTL": "Cathode electrode/PTL",
    "양극 전극/NF": "Anode electrode/NF",
