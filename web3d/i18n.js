...
(function (g) {
  ...
  const catalog = Object.assign({}, g.SIM_I18N_EN || {}, {
    ...
    "접촉각은 임의값으로 고정하지 않습니다. 완전 소수성 가정은 mesh 접촉각을 179°로 입력해 확인할 수 있습니다.": "The contact angle is not fixed to an arbitrary value. To test the perfectly hydrophobic limit, enter 179° for the mesh contact angle.",
