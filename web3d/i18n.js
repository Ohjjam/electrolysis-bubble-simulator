...
(function (g) {
  ...
  const catalog = Object.assign({}, g.SIM_I18N_EN || {}, {
    ...
    "기포 이탈크기 계수 (Fritz 기준)": "Bubble departure-size factor (Fritz basis)",
    "Fritz 비등식의 이탈반경에 곱합니다. 1=원식, 0.08=전해기포 문헌 범위(반경 약 50–150 µm)에 맞춘 교정값.": "Multiplies the Fritz boiling departure radius. 1 is the original correlation; 0.08 is calibrated to the electrolysis literature range of about 50–150 µm radius.",
